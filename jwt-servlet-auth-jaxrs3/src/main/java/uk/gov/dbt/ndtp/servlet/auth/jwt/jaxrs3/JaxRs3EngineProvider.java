...
/**
 * A provider for automatically configuring {@link JaxRs3JwtAuthenticationEngine}
 */
public class JaxRs3EngineProvider extends AbstractHeaderBasedEngineProvider {
    @Override
