...
public class TestVerificationFactory extends FactoryAbstract {
    ...
    public static <TRequest extends PublicKey> File saveJwks(PublicJwk<TRequest> jwks) throws IOException {
